...
__commander_configure ()
{
    ...
    sed -i -e "s/CORE_REPO=$CORE_REPO/CORE_REPO=$1/g" "$envFile"
    sed -i -e "s/CORE_DIR=$CORE_DIR/CORE_DIR=$2/g" "$envFile"
    sed -i -e "s/CORE_DATA=$CORE_DATA/CORE_DATA=$3/g" "$envFile"
    sed -i -e "s/CORE_CONFIG=$CORE_CONFIG/CORE_CONFIG=$4/g" "$envFile"
    sed -i -e "s/CORE_TOKEN=$CORE_TOKEN/CORE_TOKEN=$5/g" "$envFile"
    sed -i -e "s/CORE_NETWORK=$CORE_NETWORK/CORE_NETWORK=$6/g" "$envFile"
    sed -i -e "s/EXPLORER_REPO=$EXPLORER_REPO/EXPLORER_REPO=$7/g" "$envFile"
    sed -i -e "s/EXPLORER_DIR=$EXPLORER_DIR/EXPLORER_DIR=$8/g" "$envFile"
