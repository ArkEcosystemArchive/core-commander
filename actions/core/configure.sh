...
__core_configure_commander ()
{
    ...
    echo "CORE_REPO=$CORE_REPO" | tee -a "$commander_log"
    echo "CORE_DIR=$CORE_DIR" | tee -a "$commander_log"
    echo "CORE_DATA=$CORE_DATA" | tee -a "$commander_log"
    echo "CORE_CONFIG=$CORE_CONFIG" | tee -a "$commander_log"
    echo "CORE_TOKEN=$CORE_TOKEN" | tee -a "$commander_log"
    echo "CORE_NETWORK=$1" | tee -a "$commander_log"
    echo "EXPLORER_REPO=$EXPLORER_REPO" | tee -a "$commander_log"
    echo "EXPLORER_DIR=$EXPLORER_DIR" | tee -a "$commander_log"
}
